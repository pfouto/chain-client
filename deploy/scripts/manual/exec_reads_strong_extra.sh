    ...
    for reads_per in "${reads_list[@]}"; do # ---------------------------  READS_PER
      ...
      for payload in "${payloads_list[@]}"; do # ------------------------- PAYLOADS
        ...
        for alg in "${algs_list[@]}"; do # ----------------------------------- ALG
          ...
          exp_path_client="$HOME/chainpaxos/logs/read_strong/${exp_name}/client/${n_servers}/${reads_per}/${payload}/${alg}/${run}"
          exp_path_server="$HOME/chainpaxos/logs/read_strong/${exp_name}/server/${n_servers}/${reads_per}/${payload}/${alg}/${run}"
